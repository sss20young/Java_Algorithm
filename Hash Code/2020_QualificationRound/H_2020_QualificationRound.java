...
public class H_2020_QualificationRound {
	...
	public static void main(String[] args) throws IOException {
		for (int input = 0; input < input_files.length; input++) {
			br = new BufferedReader(new FileReader("C:\\Java_Algorithm\\Hash Code\\2020_QualificationRound\\input\\"+input_files[input]+".txt"));
	...
	public static void printSolution(Library[] librariesArray, int input) throws IOException {
		bw = new BufferedWriter(new FileWriter("C:\\Java_Algorithm\\Hash Code\\2020_QualificationRound\\output\\"+input_files[input]+".txt", true));
